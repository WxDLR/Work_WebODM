...
class Setting(models.Model):
    app_name = models.CharField(max_length=255, blank=False, null=False, help_text="应用名称", verbose_name='应用名称')
    app_logo = models.ImageField(upload_to="settings/", blank=False, null=False, help_text="应用logo图(像素大小为512x512，格式为.png或.jpeg格式)", verbose_name='应用图标')
    ...
    organization_name = models.CharField(default='WebODM', max_length=255, blank=True, null=True, verbose_name='组织名称')
    organization_website = models.URLField(default='https://github.com/OpenDroneMap/WebODM/', max_length=255, blank=True, null=True, verbose_name='组织网站地址')
    theme = models.ForeignKey(Theme, blank=False, null=False, on_delete=models.DO_NOTHING,
                              help_text="当前主题", verbose_name='主题')
